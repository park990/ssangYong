...
<body>
<div id="bbs">
    <form action="Controller?type=revise" method="post"
        ...
        <table summary="게시판 수정">
            ...
            <tr>
                <th>이름:</th>
                <td><input type="text" name="writer" id="writer" size="12" value="<%=vo.getWriter()%>"/></td>
            </tr>
            <tr>
                <th>내용:</th>
...
<script>
    ...
    function goBack(){
        // 취소하기를 눌렀다면 type=view, b_idx=5 &cpage=1
